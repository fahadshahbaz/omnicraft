const Card = ({ img, label, para, link }) => {
  return (
    <>
      <div className="card flex flex-col w-[350px] h-[450px] overflow-hidden transition duration-300 rounded-2xl border-4 border-solid border-[#4d4d4da2] font-roboto">
        ...
        <div className="lower-part p-4 basis-[35%]">
          ...
          <a id="btn" href={link} target="_blank" rel="noopener noreferrer">
            Link
          </a>
        </div>
      </div>
