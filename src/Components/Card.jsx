const Card = ({ img, label, para, link }) => {
  return (
    <>
      <section className="card flex flex-col w-[360px] h-[450px] overflow-hidden transition duration-300 rounded-2xl border-2 border-solid border-[#4d4d4da2] font-roboto">
