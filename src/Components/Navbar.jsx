  ...
  return (
    <header className="w-full">
      <nav className="flex justify-between items-center p-4 px-4 sm:px-16">
        ...
        className="flex justify-center items-center bg-white text-black text-sm sm:text-regular px-5 py-2 rounded-md font-semibold hover:bg-gray-300 duration-300 transition-all linear cursor-pointer">
          <svg
